...
const docTemplate = `{
        ...
        "/api/v1/auth/login": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "путь на фронте после входа",
                        "name": "return_to",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/usecases.UserInfoDTO"
                        }
                    }
                }
            }
        ...
        "/api/v1/internal/test/cleanup": {
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "префикс кода тенанта (по умолчанию test_)",
                        "name": "prefix",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.BootstrapEntAdminRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.UserCache"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        "handlers.BootstrapEntAdminRequest": {
            "type": "object",
            "required": [
                "email",
                "password",
