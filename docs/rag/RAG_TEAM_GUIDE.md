...
**Вход в браузере (Keycloak):**

```text
http://85.236.191.21:52556/api/v1/auth/login
```

Логин: `rag_service@ragcorp` (полное имя с `@ragcorp`). Пароль — у администратора (`RAG_FIXTURES_PASSWORD`, по умолчанию `RagTest2026!`).
