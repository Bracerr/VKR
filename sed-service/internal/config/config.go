...
type Config struct {
	...
	ProductionCallbackURL    string `mapstructure:"production_callback_url"`
	ProductionCallbackSecret string `mapstructure:"production_callback_secret"`
...
func setDefaults(v *viper.Viper) {
	v.SetDefault("http_addr", ":8091")
	v.SetDefault("log_level", "info")
	v.SetDefault("db_dsn", "postgres://sed:sed@localhost:5434/sed?sslmode=disable")
	...
	v.SetDefault("minio_secret_key", "minio12345")
	v.SetDefault("minio_bucket", "sed-files")
	v.SetDefault("minio_use_ssl", false)
	v.SetDefault("warehouse_base_url", "http://localhost:8090")
	v.SetDefault("warehouse_service_secret", "")
	v.SetDefault("production_callback_url", "")
