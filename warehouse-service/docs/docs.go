...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/inventory/lines/{line_id}": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/operations/issue-from-reservations": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
